...
class CommandClassifier {
     ...
     */
    static classify(toolName, parameters) {
     ...
     */
    static isMutating(toolName) {
        return (DESTRUCTIVE_TOOLS.has(toolName) || ELEVATED_TOOLS.has(toolName));
    }
    /**
     * Extract the target file path from tool parameters (handles
     * different naming conventions across Roo Code / Cline).
     */
    static extractTargetPath(toolName, parameters) {
     ...
     */
    static extractContent(toolName, parameters) {
