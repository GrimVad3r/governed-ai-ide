...
exports.GOVERNANCE_TOOLS = exports.RECORD_LESSON_SCHEMA = exports.MARK_INTENT_COMPLETE_SCHEMA = exports.EXPAND_INTENT_SCOPE_SCHEMA = exports.SELECT_ACTIVE_INTENT_SCHEMA = void 0;
// ── Tool Schema (inject into system prompt / tool registry) ──
exports.SELECT_ACTIVE_INTENT_SCHEMA = {
  ...
  `.trim(),
    input_schema: {
        ...
        properties: {
            intent_id: {
                type: "string",
                description: "The intent ID from active_intents.yaml, e.g. 'INT-001'. " +
...
exports.EXPAND_INTENT_SCOPE_SCHEMA = {
  ...
  `.trim(),
    input_schema: {
        ...
        properties: {
            ...
            new_glob: {
                type: "string",
                description: "The glob pattern to add to owned_scope, e.g. 'src/shared/**'",
            },
            justification: {
                type: "string",
                description: "Explain WHY this file is necessary for the intent. Be specific.",
            },
        },
        required: ["intent_id", "new_glob", "justification"],
    },
};
exports.MARK_INTENT_COMPLETE_SCHEMA = {
  ...
  `.trim(),
    input_schema: {
        ...
        properties: {
            ...
            completion_notes: {
                type: "string",
                description: "Brief summary of what was done and any deviations from the original plan.",
            },
        },
        required: ["intent_id", "completion_notes"],
    },
};
exports.RECORD_LESSON_SCHEMA = {
    name: "record_lesson",
    description: `
  ...
  `.trim(),
    input_schema: {
        ...
        properties: {
            ...
            lesson: {
                type: "string",
                description: "The lesson learned. Be specific and actionable for future agents.",
            },
            failure_type: {
                type: "string",
...
exports.GOVERNANCE_TOOLS = [
    exports.SELECT_ACTIVE_INTENT_SCHEMA,
    exports.EXPAND_INTENT_SCOPE_SCHEMA,
    exports.MARK_INTENT_COMPLETE_SCHEMA,
    exports.RECORD_LESSON_SCHEMA,
];
//# sourceMappingURL=select_active_intent.js.map